...
const UpdateUser = () => {
    ...
    useEffect( ()=>{
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://notesapp-4ia4.onrender.com/userwithnotes/${id}`, {
    ...
    async function printing(e){
        ...
        if(objectname.notesname!=="" && objectname.notesmessage!=="")
            {
        try {
            const response = await axios.put(`https://notesapp-4ia4.onrender.com/usernoteupdate/${id}`, {
